...
{
	gate->scanhash = (void*)&scanhash_argon2d_uis;
	gate->hash = (void*)&argon2d_uis_hash;
	gate->set_target = (void*)&scrypt_set_target;
	gate->optimizations = SSE2_OPT | AES_OPT | AVX_OPT | AVX2_OPT;
}

void argon2d_uis_hash(void *output, const void *input)
{
...
int scanhash_argon2d_uis( int thr_id, struct work *work, uint32_t max_nonce, uint64_t *hashes_done )
{
	...
	do {
		...
		argon2d_uis_hash(hash, endiandata);
